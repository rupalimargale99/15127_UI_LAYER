...
namespace MVCDemoAppMastek.Controllers
{
    public class EmpController : Controller
    {
        ...
        {
            //var data = (from e in db.Emps join d in db.Depts on e.Deptno equals d.Deptno select new EmpDeptViewModel(Config){ Employee = e, Department = d }).ToList();
            //return View(data);

            var data = (from e in db.Emps join d in db.Depts on e.Deptno equals d.Deptno into joindata
                        from deptobj in joindata.DefaultIfEmpty() orderby deptobj.Dname select new EmpDeptViewModel(Config)
                        { Employee = e, Department = deptobj }).ToList();
            return View(data);
